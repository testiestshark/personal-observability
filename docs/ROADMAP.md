...
- **Weight tracking — the first data domain wired end-to-end.** Schema and RLS via migration, kilogram scroll-wheel entry, month calendar, full weigh-in history, and a CSV backfill script for historic entries.
